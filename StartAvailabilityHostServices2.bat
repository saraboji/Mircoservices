...
call java -jar .\AvailabilityHostServices\target\AvailabilityHostServices-0.0.1-SNAPSHOT.jar  --eureka.client.serviceUrl.defaultZone=http://%ip%:8762/eureka/,http://%remotenode%:8761/eureka/  --server.port=7112 --spring.data.mongodbport=27017  --eureka.instance.leaseRenewalIntervalInSeconds=1 --eureka.instance.leaseExpirationDurationInSeconds=2